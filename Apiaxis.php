...
class ApiAXIS
{
    ...
    //-------------------------------
        ...
        {
            echo "$Green âž¤ $message_buy_v2 !\n";
        }else{
            echo "$Red âž¤ $message_buy_v2 !\n";
        }
    }
    ...
    //-------------------------------
        ...
        {
            echo "$Green âž¤ $message_buy_v3 !\n";
        }else{
            echo "$Red âž¤ $message_buy_v3 !\n";
        }
    }  
}
...
if($status_otp==true)
{
    echo "$Green âž¤ $message_otp !\n";
} else {
    echo "$Red âž¤ $message_otp !\n";
    echo "\n";
    goto repeat_otp;
}
...
if($status_login==true)
{
    ...
    echo "$Green âž¤ $message_login !\n";
} else {
    $token = "";
    echo "$Red âž¤ $message_login !\n";
    echo "\n";
    goto repeat_token;
}
